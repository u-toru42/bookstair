...
ActiveRecord::Schema[7.0].define(version: 20_230_425_041_450) do
  ...
  create_table 'bookmark_tag_relations', force: :cascade do |t|
    ...
    t.index %w[tag_id bookmark_id], name: 'index_bookmark_tag_relations_on_tag_id_and_bookmark_id', unique: true
  ...
  create_table 'favorites', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index ['book_isbn'], name: 'index_favorites_on_book_isbn'
    t.index %w[user_id book_isbn], name: 'index_favorites_on_user_id_and_book_isbn', unique: true
