...
ActiveRecord::Schema[7.0].define(version: 2022_12_12_103753) do
  ...
  add_foreign_key "bookchecks", "books"
  add_foreign_key "bookchecks", "bookshelf_lines"
  add_foreign_key "bookmarks", "books"
  add_foreign_key "bookmarks", "users"
  add_foreign_key "bookshelf_boards", "bookshelf_follows"
  add_foreign_key "bookshelf_boards", "users"
  add_foreign_key "bookshelf_follows", "bookshelf_boards"
  add_foreign_key "bookshelf_follows", "bookshelves"
  add_foreign_key "bookshelf_lines", "bookshelves"
